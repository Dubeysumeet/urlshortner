  ...
  return (
    ...
    <div className='flex flex-col md:flex-row gap-5 border p-4 bg-gray-900 rounded-lg'>
        ...
        <Link to={`/link/${url?.id}`} className='flex flex-col flex-1'>
            ...
            <span className="text-2xl text-blue-400 font-bold hover:underline cursor-pointer">https://urlshortner-sd.vercel.app/{url?.custom_url ? url?.custom_url : url?.short_url}</span>
        ...
        <Button
          variant="ghost"
          onClick={() =>
            navigator.clipboard.writeText(`https://urlshortner-sd.vercel.app/${url?.short_url}`)
          }
        >
          <Copy />
        </Button>
